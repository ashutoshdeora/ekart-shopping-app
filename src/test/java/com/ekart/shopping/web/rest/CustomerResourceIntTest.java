...
public class CustomerResourceIntTest {
    ...
    private static final Long DEFAULT_CUSTOMER_CATEGORY = 1L;
    private static final Long UPDATED_CUSTOMER_CATEGORY = 2L;
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getCreditRating()).isEqualTo(DEFAULT_CREDIT_RATING);
    }
    ...
    public void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].customerCategory").value(hasItem(DEFAULT_CUSTOMER_CATEGORY.intValue())))
            .andExpect(jsonPath("$.[*].userId").value(hasItem(DEFAULT_USER_ID.toString())))
            .andExpect(jsonPath("$.[*].creditRating").value(hasItem(DEFAULT_CREDIT_RATING.toString())));
    }
    ...
    public void getCustomer() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers/{id}", customer.getId()))
            ...
            .andExpect(jsonPath("$.customerCategory").value(DEFAULT_CUSTOMER_CATEGORY.intValue()))
            .andExpect(jsonPath("$.userId").value(DEFAULT_USER_ID.toString()))
            .andExpect(jsonPath("$.creditRating").value(DEFAULT_CREDIT_RATING.toString()));
    }
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getCreditRating()).isEqualTo(UPDATED_CREDIT_RATING);
    }
